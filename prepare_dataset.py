...
DATASET_PATH = "/media/alon/DATA/ProjectsForCV/proj1/dataset"
JSON_PATH = "/media/alon/DATA/ProjectsForCV/proj1/data.json"
...
def prepare_dataset(dataset_path, json_path, n_mfcc=13, hop_length=512, n_fft=2048):
    ...
    for i, (dirpath, dirnames, filenames) in enumerate(os.walk(dataset_path)):
        ...
        # we needto ensure that we're not at root level
